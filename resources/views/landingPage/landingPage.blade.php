...
<body class="font-display">
    <div class="bg-[#3281C4] mb-16 h-screen w-full relative">
        ...
        <div class="flex flex-col items-center mt-8 lg:flex-row lg:justify-evenly lg:mt-24">
                <div class="mt-8 max-w-xs h-full bg-white border border-gray-200 shadow-xl rounded-3xl md:w-3/4">
                    <div class="flex flex-col items-center pt-10 pb-10">
                        ...
                        <h5 class="text-base mt-10 mb-1 font-semibold text-center text-gray-900 md:text-xl">Perusahaan</h5>
                        <span class="text-xs px-12 pb-1 mt-16 md:text-sm text-center text-gray-500">Anda yang menginginkan karyawan perusahaan menjadi semakin terampil dan profesional</span>
                ...
                <div class="mt-8 h-full bg-white border border-gray-200 shadow-xl rounded-3xl max-w-xs md:w-3/4">
                    <div class="flex flex-col items-center pt-10 pb-10">
                        <img class="mb-3 rounded-full shadow-lg w-52 h-52" src="{{ asset('image/si paling ngonten.png') }}" alt="gambar"/>
                        <h5 class="text-base mt-10 mb-1 font-semibold text-center text-gray-900 md:text-xl">Content <br>Creator</h5>
                ...
                <div class="mt-8 h-full bg-white border border-gray-200 shadow-xl rounded-3xl max-w-xs md:w-3/4">
                    <div class="flex flex-col items-center pt-10 pb-10">
                        ...
                        <h5 class="text-base mt-10 mb-1 font-semibold text-center text-gray-900 md:text-xl">Netizen</h5>

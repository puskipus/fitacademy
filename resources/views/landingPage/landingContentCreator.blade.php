...
<div class="bg-[#3281C4] h-[48rem]">
    ...
    <div class="text-center text-white lg:text-start lg:ml-36">
        <div class="mt-10">
            <h1 class="text-xl font-bold leading-normal tracking-widest md:text-3xl lg:text-4xl lg:text-start lg:pr-80">CONTENT CREATOR GUIDE: Asik Mengedukasi dengan Metode Microlearning</h1>
        </div>
